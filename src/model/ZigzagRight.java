...
public class ZigzagRight implements Figure {
    ...
    public ZigzagRight(Color color) {

        rotNum = 0;
        rotation1 = new ArrayList<>();
        Collections.addAll(rotation1, new Point(3, 1), new Point(3, 0), new Point(2, 2), new Point(2, 1));

        rotation2 = new ArrayList<>();
        Collections.addAll(rotation2, new Point(2,0), new Point(3, 1), new Point(3,0), new Point(4, 1));

        rotation3 = new ArrayList<>();
        Collections.addAll(rotation3, new Point(3, 2), new Point(3,1), new Point(4,1), new Point(4,0));

        rotation4 = new ArrayList<>();
        Collections.addAll(rotation4, new Point(2, 1), new Point(3, 2), new Point(3,1), new Point(4,2));
